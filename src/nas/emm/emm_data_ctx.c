...
void emm_init_context(struct emm_context_s * const emm_ctx, const bool init_esm_ctxt)
{
  ...
  if (init_esm_ctxt) {
	  ...
	  printf("-----------------------------------------------in emm_data_ctx.c  emm_init_context();----------------------------------\n\n");
	  printf("n_active_ebrs:%d\n",esm_t.n_active_ebrs);
	  printf("n_active_pdns:%d\n",esm_t.n_active_pdns);
	  printf("n_pdns:%d\n",esm_t.n_pdns);
	  printf("is_emergency:%d\n",esm_t.is_emergency);
	  printf("timer id:%ld",esm_t.T3489.id);
	  printf("sec:%ld",esm_t.T3489.sec);
	  printf("-----------------------------------------------in emm_data_ctx.c  emm_init_context();----------------------------------\n\n");
      /*if(ESM_DEBUG)*/
      /*{*/
